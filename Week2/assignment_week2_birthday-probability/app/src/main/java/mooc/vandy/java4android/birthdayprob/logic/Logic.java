...
public class Logic 
    ...
    */
    ...
    public double calculate(int size, int count) {
        ...
        // a list to store the newly generated dobs of the candidates.
        List<Integer> dobList = new ArrayList<int>();

        // the Random object to generate the random dates. dates from 0-365(Jan1 till dec31)
        Random rand = new Random();

        //assigning the ages to the people in the group
        int simulationSuccessCount=0;

        for(int i=0;i<size;i++){
            int age = rand.nextInt(365);

            if(dobList.contains(age)) {
        ...
        return (double)simulationSuccessCount*100/size;
    }
